          ...
          <div class="box">
            <div class="box-header">
              ...
              <table class="table" style="width: 100%">
                  ...
                  <th>
                    <label><input type="checkbox" value="Active" name="status" <?php if(!empty($_POST['status']) && $_POST['status'] == 'Active'){ echo "checked = checked"; } ?>>Active</label>
                  ...
                  <th>
                   <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_addThesis"> Add User</button>
                  </th>
              </table>
              </form>
            ...
            <table class="table table-bordered" style="width:100%;">
              ...
              <tr>
                ...
                <td>
                  ...
                  ?>
                      <a href="admin_users.php?reactivate_user_id=<?php echo $rowUsers['user_id']?>" onClick="return confirm('Sure To Reactivate This Record?');" class="btn btn-sm btn-success" data-toggle="tooltips"><i class="fa fa-refresh"></i></a>
                  <?php
                      }
                      else {
                  ?>
