    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       <li class="active"><a href="admin_dashboard.php"><i class="fa fa-th"></i> <span>Dashboard</span></a></li>
        ...
        <li>
          <a href="admin_thesis.php"><i class="fa fa-book"></i> <span>Theses</span></a>
        </li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <?php
                $queryCountVisitors = "SELECT COUNT(*) as count FROM tblUsers WHERE user_type LIKE('%visitor%')";
                $queryVisitorCount = mysqli_query($conn, $queryCountVisitors);
                $countVisitorResult = mysqli_fetch_array($queryVisitorCount);
            ?>
            <div class="inner">
              <h3><?php echo $countVisitorResult['count'];?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <?php
                //Query to count the number of existing thesis in the database
                $queryCountTheses = "SELECT COUNT(*) as count from tblThesis";
                $queryCountResult = mysqli_query($conn, $queryCountTheses);
                $countThesisResult = mysqli_fetch_array($queryCountResult);
          ?>
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $countThesisResult['count'];?></h3>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <!-- <div class="nav-tabs-custom"> -->
            ...
            <!-- <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i>Overall Number of Views</li>
            </ul>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Visitor's Count</h3>
...
?>
<p id="helloMo"><?php echo $helloKo ?></p>
<p id="data1"><?php echo $dat1; ?></p>
<p id="data2"><?php echo $dat2; ?></p>

<script type="text/javascript">
  var helloMo = $("#helloMo").text();
  //alert(helloMo);
  var dat1 = $("#data1").text();
  var dat2 = $("#data2").text();
  ...
  dat1_array = dat1_array.concat(dat1_array);
  dat2_array = dat2_array.concat(dat2_array);

  var bilang = dat1_array.count - 1;

/**
  dat1_array = jQuery.grep(dat1_array, function(value)){
    return value != '';
  }

  dat2_array = jQuery.grep(dat2_array, function(value)){
    return value != '';
  }

  var morrisData = [];

  $.each(dat1_array, function(key, val)){
    morrisData.push({'y': dat1_array[key], 'item1' : dat2_array[key]},);
  }
*/
