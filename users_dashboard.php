<?php
  ...
  elseif(isset($_GET['cat'])){
    $cat = $_GET['cat'];
    if($cat == 'mostcited') {
      $queryThesis = "SELECT DISTINCT(thesis_id), COUNT(thesis_id) as citation_count FROM tblThesis_citation WHERE citation_count > 50 GROUP BY thesis_id ";
      $queryThesisResult = mysqli_query($conn, $queryThesis);
    }
  }
  else{
...
<head>
  ...
  <title>Thesys | Dashboard (Faculty)</title>
              ...
              <div class="btn-group btn-group-justified">
                <?php
                  ...
                  foreach($alphabetPage as $key)
                    {
                ?>
                    <div class="btn-group"><a href="users_dashboard.php?namestart=<?php echo $key ?>"><button type="button" class="btn btn-primary btn-sm"><?php echo $key?></button></a></div>
                <?php      
                    }
                ?>
              </div>
          ...
          <div class="box">
            ...
            <div class="box-body">
             <?php 
                ...
                {
             ?>
                  <p><a href="users_view_category.php?selectedCategory=<?php echo $rowCategory['id']?>"><?php echo $rowCategory['category_name']?></a></p>
             <?php
                }
             ?>
