<?php
  ...
  if(isset($_GET['cite_thesis_id']))
  {
      ...
      $queryCiteThesis = "INSERT INTO tblThesis_Citation(thesis_id, user_id, date_and_time) 
                          VALUES('$viewThesisID', '$userID', now())";
            ...
            <div class="box-body">
              <div class="col-sm-8">
                <div class="row">
                  <div class="col-sm-6">
                  <?php
                    // $queryCheckIfCited = "SELECT * FROM tblThesis_Citation WHERE user_id = '$userID'";
                    // $checkIfCitedRes = mysqli_query($conn, $queryCheckIfCited);
                  ?>
                  ...
                  <div class="col-sm-6"><a href="users_thesis_download.php?file=<?php echo urlencode($rowThesis['file']); ?>&user_id=<?php echo $userID ?>&thesis_id= <?php echo $viewThesisID?>" class="btn btn-block btn-success"><i class="fa fa-download"></i></a></div>
                  <?php
                    }
                  ?>
                </div>               
            ...
            <div class="box-header"><h4>Suggested Theses</h4></div>
              <div class="box-body">
                ...
                if(isset($_GET['thesis_id'])) { 
                  ...
                  $querySuggest = "SELECT thesis_id, COUNT(thesis_id) as Suggestion from tblThesis_views WHERE NOT(user_id = '$userID') AND NOT(thesis_id = '$thesisID') GROUP by thesis_id LIMIT 5";
              ...
              elseif (isset($_GET['cite_thesis_id'])){
              	  $thesisID = $_GET['cite_thesis_id'];	
                  $querySuggest = "SELECT thesis_id, COUNT(thesis_id) as Suggestion from tblThesis_views WHERE NOT(user_id = '$userID') AND NOT(thesis_id = '$thesisID') GROUP by thesis_id LIMIT 5";
                  $suggestRes = mysqli_query($conn, $querySuggest);
